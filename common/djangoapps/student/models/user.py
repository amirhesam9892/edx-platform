...
def log_course_access_role_save(sender, instance, created, **kwargs):
    """
    Logs create and update actions for CourseAccessRole objects.
    """
...
def log_course_access_role_delete(sender, instance, **kwargs):
    """
    Logs delete actions for CourseAccessRole objects.
    """
    current_user = crum.get_current_user()
    CourseAccessRoleHistory.objects.create(
        user=instance.user,
